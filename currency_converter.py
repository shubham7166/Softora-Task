...
head_label = tk.Label(Top,font=('lato yellow',19,'bold'),
	text='                           C U R R E N C Y  C O N V E R T E R              '              ,bg='#e6e5e5', fg='black')
...
Label_1 = Label(root, font=(' black', 16, 'bold'), text="                   W E L C O M E", padx=200,
 pady=15, bg="#e6e5e5", fg="blue")
...
Label_3 = Button(root,font=('arial',15,'bold'),text="  Convert ",padx=2,pady=2,bg='yellow',fg='black',
...
Label_3=Button(root,font=('arial',15,'bold'),text="  Clear All  ",padx=2, pady=2, bg='lightgreen',fg='black',
	command = clear_all)
